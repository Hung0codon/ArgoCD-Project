...
> 
<img width="773" height="531" alt="image" src="https://github.com/user-attachments/assets/433e79bc-1678-4b1e-adb3-d8937720a9c6" />
...
### 🎮 4. Giao diện Game Tài Xỉu Premium (Frontend)
* **Lệnh khởi chạy:**
  ```powershell
  kubectl port-forward -n demo svc/taixiu-frontend 30080:80
  ```
* **Địa chỉ truy cập:** `http://localhost:30080`
* **Vai trò:** Giao diện trực quan người dùng chơi game Tài Xỉu, tương tác đặt cược để gửi dữ liệu về backend và tạo ra các metrics truyền tải cho Prometheus.
* **Ảnh chụp màn hình Game Frontend:**
  
  ![Game Frontend UI](images/taixiu-frontend.png)
